              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  double distance = calculateDistance(currentLatitude,
                      currentLongitude, item.latitude, item.longitude);
                  return Column(
                    children: [
                      Padding(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<Map<String, dynamic>> profiles =
                      ...
                      profileData['documentId'] =
                          documentId; // Add document ID to the data
                      return profileData;
                    }).toList();
                    ...
                    return GridView.builder(
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          crossAxisCount: 2,
                          childAspectRatio: .7 // Adjust as needed
                          ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                        "${calculateAge(DateTime.parse(profile['dob']))} years"),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        left: 10.0, top: 5),
