        ...
        children: [
          ...
          InkWell(
            onTap: () async {
              if (formkey.currentState!.validate()) {
                ...
                Merchant merchant = Merchant(
                  ...
                  images: imagePaths,
                  image:"https://firebasestorage.googleapis.com/v0/b/homeless-399009.appspot.com/o/profile_images%2Fimages.jpeg?alt=media&token=5058eabd-d0e5-4387-9fe2-dfb4b0e16497",
                  //bank
                ...
                await firestoreService.addMerchantData(merchant).then((value) {
                  ...
                  Alert(context: context,title: "Register Successfully" , type: AlertType.success,buttons: [
            ...
            child: Container(
                ...
                child: isloading ? Center(child: CircularProgressIndicator(color: Colors.white,)) : Text('Register',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 18,
